...
namespace NinjaTrader.NinjaScript.DrawingTools
{
    ...
    public class TimeCycles : DrawingTool
    {
        ...
        public override IEnumerable<ChartAnchor>    Anchors         { get { return new ChartAnchor[] { StartAnchor, EndAnchor }; } }
        ...
        public override Cursor GetCursor(ChartControl chartControl, ChartPanel chartPanel, ChartScale chartScale, Point point)
        {
            ...
            else if (IsPointOnTimeCyclesOutline(chartControl, chartPanel, chartScale, point))
        ...
        public override bool IsAlertConditionTrue(AlertConditionItem conditionItem, Condition condition, ChartAlertValue[] values, ChartControl chartControl, ChartScale chartScale)
        {
            ...
            {
                bool isInside = IsPointInsideTimeCycles(chartControl, chartPanel, chartScale, getBarPoint(v));
        ...
        private bool IsPointInsideTimeCycles(ChartControl chartControl, ChartPanel chartPanel, ChartScale chartScale, Point p)
        {
            if (radius < 0)
                return false;
        ...
        private bool IsPointOnTimeCyclesOutline(ChartControl chartControl, ChartPanel chartPanel, ChartScale chartScale, Point p)
        {
            if (radius < 0)
                return false;
        ...
        private void UpdateAnchors(ChartControl chartControl, ChartBars chartBars, int startX)
        {
